...
public class ConstController : ControllerBase
{
    ...
    public async Task<IActionResult>Post(CONSTANTES entity)
    {
        try
        {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult>Put(int id,CONSTANTES entity)
    {
        try {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<CONSTANTES>> Get(int id)
    {
        try
        {
    ...
    public async Task<IEnumerable<CONSTANTES>> GetAll()
    {
        try
        {
